...
struct SettingsView: View {
        ...
        VStack{
            List {
                ...
                Section(header: Text("Socials")) {
                    Button(action: {
                        UIApplication.shared.open(URL(string: "https://brand.masterbros.dev")!)
                    }) {
                        Text("Website")
    ...
    private func shareApp() {
        let activityViewController = UIActivityViewController(activityItems: ["Check out the app that helps you get over your addictions! Here's the link: brand.masterbros.dev"], applicationActivities: nil)
